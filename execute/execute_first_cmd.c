...
/*                                                   +#+                      */
/*   Created: 2023/12/14 01:50:49 by bootjan       #+#    #+#                 */
/*   Updated: 2023/12/16 15:53:49 by bschaafs      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static void	first_cmd(t_tokens *cmd, char **envp, t_pipes pipes)
{
	int		fd_in;
	int		fd_out;
	int		builtin_int;
